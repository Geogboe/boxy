...
### Phase 1 (v1-prerelease): File-based Configuration + SQLite State
...
### Why Config Files for v1-prerelease?
...
### Why Not PostgreSQL for v1-prerelease?

- Requires separate process/container
- Adds deployment complexity
- Overkill for single-node v1-prerelease
...
- **Single Node**: SQLite limits scaling (but v1-prerelease is single-node anyway)
...
**Rejected for v1-prerelease**: Requires API server, more complex, harder to version control.
...
**Rejected**: Unnecessary complexity for v1-prerelease, easy migration path available.

## References

- [Tech Stack Research - State Storage](../architecture/tech-stack-research.md#database-options-analysis)
- [ROADMAP - Phase 1 Scope](../ROADMAP.md#phase-1-v1-prerelease---single-backend-docker)
