...
REPO="Geogboe/boxy"
BINARY="boxy"
INSTALL_DIR="${BOXY_INSTALL_DIR:-${HOME}/.local/bin}"
TMPDIR_CLEANUP=""
...
resolve_version() {
    ...
    local api_base="${BOXY_BASE_URL:-https://api.github.com}"
    local version
...
main() {
    ...
    local download_base="${BOXY_BASE_URL:-https://github.com}/${REPO}/releases/download/${version}"
